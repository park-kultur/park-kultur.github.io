export const showsData = [
  {
    ...
    gallery: {
      ...
      images: [
        { src: 'media/Gallery/01.webp', alt: '01' },
        { src: 'media/Gallery/02.webp', alt: '02' },
        { src: 'media/Gallery/03.webp', alt: '03' },
        { src: 'media/Gallery/04.webp', alt: '04' },
        { src: 'media/Gallery/05.webp', alt: '05', topAligned: true },
        { src: 'media/Gallery/06.webp', alt: '06' },
        { src: 'media/Gallery/07.webp', alt: '07' },
        { src: 'media/Gallery/08.webp', alt: '08' },
        { src: 'media/Gallery/09.webp', alt: '09' },
      ],
    },
  },
  {
    ...
    gallery: {
      ...
      images: [
        { src: 'media/Gallery/ELENA SERGEEVNA PHOTOS/001.webp', alt: '001' },
        { src: 'media/Gallery/ELENA SERGEEVNA PHOTOS/002.webp', alt: '002' },
        { src: 'media/Gallery/ELENA SERGEEVNA PHOTOS/003.webp', alt: '003' },
        { src: 'media/Gallery/ELENA SERGEEVNA PHOTOS/004.webp', alt: '004' },
        { src: 'media/Gallery/ELENA SERGEEVNA PHOTOS/005.webp', alt: '005' },
        { src: 'media/Gallery/ELENA SERGEEVNA PHOTOS/006.webp', alt: '006' },
        { src: 'media/Gallery/ELENA SERGEEVNA PHOTOS/007.webp', alt: '007' },
      ],
    },
  },
  {
...
export function getShowSwiperConfigs() {
  return showsData
